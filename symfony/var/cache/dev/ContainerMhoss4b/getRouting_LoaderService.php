...
$d = new \Sensio\Bundle\FrameworkExtraBundle\Routing\AnnotatedRouteControllerLoader($e);
...
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($c, $f, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($c, $f, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$b->addLoader($g);
